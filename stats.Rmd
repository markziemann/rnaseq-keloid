...
tissue_r <- mitch_calc(x=tissue,genesets=reactome,priority="effect")
head(tissue_r$enrichment_result,20)
tissue_m <- mitch_calc(x=tissue,genesets=msigdb,priority="effect",cores=12)
...
cells_r <- mitch_calc(x=cells,genesets=reactome,priority="effect")
head(cells_r$enrichment_result,20)
cells_m <- mitch_calc(x=cells,genesets=msigdb,priority="effect",cores=12)
